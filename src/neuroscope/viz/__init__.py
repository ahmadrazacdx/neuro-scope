...
def plot_learning_curves(history, figsize=(9, 4), ci=False, markers=True, save_path=None, metric='accuracy'):
    """Plot training and validation learning curves."""
    viz = Visualizer(history)
    return viz.plot_learning_curves(figsize, ci, markers, save_path, metric)

def plot_activation_hist(history, epoch=None, figsize=(9, 4), kde=False, last_layer=False, save_path=None):
...
def plot_gradient_hist(history, epoch=None, figsize=(9, 4), kde=False, last_layer=False, save_path=None):
...
def plot_weight_hist(history, epoch=None, figsize=(9, 4), kde=False, last_layer=False, save_path=None):
    """Plot weight value distributions across network layers."""
    viz = Visualizer(history)
    return viz.plot_weight_hist(epoch, figsize, kde, last_layer, save_path)

def plot_activation_stats(history, activation_stats=None, figsize=(12, 4), save_path=None, reference_lines=False):
    """Plot activation statistics evolution over training epochs."""
    viz = Visualizer(history)
    return viz.plot_activation_stats(activation_stats, figsize, save_path, reference_lines)

def plot_gradient_stats(history, figsize=(12, 4), save_path=None, reference_lines=False):
...
def plot_update_ratios(history, update_ratios=None, figsize=(12, 4), save_path=None, reference_lines=False):
...
def plot_gradient_norms(history, gradient_norms=None, figsize=(12, 4), save_path=None, reference_lines=False):
...
__all__ = [
    ...
    "plot_learning_curves", "plot_activation_hist", "plot_gradient_hist", "plot_weight_hist",
    "plot_activation_stats", "plot_gradient_stats", "plot_weight_stats", 
    "plot_update_ratios", "plot_gradient_norms", "plot_training_animation"
]